...
public class IntakeSim implements IntakeIO {
    ...
    private final SingleJointedArmSim armSimModel = new SingleJointedArmSim(
            ...
            Constants.Intake.ARM_DOWN_POSITION,
            Constants.Intake.ARM_STARTING_POSITION,
            true,
            Constants.Intake.ARM_STARTING_POSITION,
            0.0,
            0.0);
    ...
    public void setArmPositionRotations(double newValue) {
        ...
        armSimLeader.setRawRotorPosition(Constants.Intake.ARM_GEAR_RATIO
                * Units.radiansToRotations(armSimModel.getAngleRads() - Constants.Intake.ARM_STARTING_POSITION));
