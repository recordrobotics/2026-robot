...
public class Intake extends KillableSubsystem implements PoweredSubsystem {
    ...
    private double armTargetRotations = Units.radiansToRotations(Constants.Intake.ARM_STARTING_POSITION);
    ...
    public Intake(IntakeIO io) {
        this.io = io;
        armLeaderRequest = new MotionMagicExpoVoltage(Units.radiansToRotations(Constants.Intake.ARM_STARTING_POSITION));
    ...
    public void setState(IntakeState state) {
        armTargetRotations = switch (state) {
            case INTAKE -> Units.radiansToRotations(Constants.Intake.ARM_DOWN_POSITION);
            case EJECT -> Units.radiansToRotations(Constants.Intake.ARM_DOWN_POSITION);
            case STARTING -> Units.radiansToRotations(Constants.Intake.ARM_STARTING_POSITION);
            case RETRACTED -> Units.radiansToRotations(Constants.Intake.ARM_RETRACTED_POSITION);
        };
    ...
    public void resetEncoders() {
        io.setArmPositionRotations(Constants.Intake.ARM_STARTING_POSITION);
    }
