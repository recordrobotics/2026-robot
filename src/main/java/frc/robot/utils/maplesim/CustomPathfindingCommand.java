...
public class CustomPathfindingCommand extends Command {
    ...
    public void execute() {
        ...
        boolean skipUpdates = currentTrajectory != null
                && currentPose
                                .getTranslation()
                                .getDistance(
                                        currentTrajectory.getEndState().pose.getTranslation())
                        < 2.0;
        ...
        if (!skipUpdates && pathfinder.isNewPathAvailable()) {
            ...
            if (currentPath != null) {
                ...
                PathPlannerTrajectoryState closestState1 = currentTrajectory.getState(closestState1Idx);
        ...
        if (currentTrajectory != null) {
            PathPlannerTrajectoryState targetState = currentTrajectory.sample(timer.get() + timeOffset);
