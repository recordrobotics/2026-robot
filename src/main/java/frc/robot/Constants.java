...
public final class Constants {
    ...
    public static final class Intake {
        ...
        public static final double ARM_DOWN_POSITION = Units.degreesToRadians(
                0.0); // should always be 0, TODO offset motionmagic gravity arm position offset based on cg
        public static final double ARM_RETRACTED_POSITION = Units.degreesToRadians(81.0);
        public static final double ARM_STARTING_POSITION = Units.degreesToRadians(120.0);
